...
favoriteThings.show = "Yu Yu Hakusho";
/*
...
const wizard = new Wizard("Fritz McGoober", 77, "magic missle");
...
const phoneOne = new Phone("Apple", "iPhone X", 512, "Space Grey", 2000);
const phoneTwo = new Phone("Galaxy", "Blueberry", 32, "Dark Blue", 250);
const phoneThree = new Phone("Google", "Pixel 64", 64, "White", 600);
/* 
